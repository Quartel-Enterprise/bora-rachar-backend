...
VALUES(1, 'Peladinha', '', '', 1, '2024-01-15 12:00:00', NULL, NULL);
INSERT INTO BORA_RACHAR.`group`(id, name, avatar, access_code, created_by, created_at, updated_at, deleted_at)
...
INSERT INTO BORA_RACHAR.expense_payment_split(id, user_id, expense_id, value, created_at, is_debt_settled, deleted_at)
VALUES(1, 1, 1, 15.5000, '2006-01-02 15:04:05', 0, NULL);
INSERT INTO BORA_RACHAR.expense_payment_split(id, user_id, expense_id, value, created_at, is_debt_settled, deleted_at)
VALUES(2, 2, 1, 4.5000, '2006-01-02 15:04:05', 0, NULL);
